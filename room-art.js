...
const fallback={generator:'assets/generator-room.b64?v=8',workshop:'assets/workshop-room.b64?v=8',greenhouse:'assets/greenhouse-room.b64?v=9'};
const images={};
...
loadDirect('generator',direct.generator);loadDirect('workshop',direct.workshop);loadFallback('greenhouse',fallback.greenhouse);
})();