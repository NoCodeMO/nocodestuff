...
for(const marker of ['js/systems/prestige.js?build=3','app.css?build=46','js/core/state.js?build=22','js/systems/operations.js?build=2','js/core/game.js?build=23'])assert(html.includes(marker),`cache marker missing: ${marker}`);
