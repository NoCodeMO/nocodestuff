...
assert(/schema:19/.test(state)&&/prestige:\{level:0,cores:0/.test(state),'save schema 19 must safely initialize Prestige state');
...
for(const marker of ['js/systems/prestige.js?build=3','app.css?build=45','js/core/state.js?build=22','js/systems/operations.js?build=2','js/core/game.js?build=23'])assert(html.includes(marker),`cache marker missing: ${marker}`);
