...
assert(/schema:18/.test(state)&&/prestige:\{level:0,cores:0/.test(state),'save schema 18 must safely initialize Prestige state');
...
for(const marker of ['js/systems/prestige.js?build=3','app.css?build=33','js/core/state.js?build=19','js/systems/operations.js?build=1','js/core/game.js?build=21'])assert(html.includes(marker),`cache marker missing: ${marker}`);
