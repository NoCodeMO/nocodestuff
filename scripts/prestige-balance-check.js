...
for(const marker of ['js/systems/prestige.js?build=4','app.css?build=60','js/core/state.js?build=27','js/systems/operations.js?build=3','js/core/game.js?build=28'])assert(html.includes(marker),`cache marker missing: ${marker}`);
