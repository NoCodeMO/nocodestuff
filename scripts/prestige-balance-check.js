...
for(const marker of ['js/systems/prestige.js?build=3','app.css?build=56','js/core/state.js?build=23','js/systems/operations.js?build=2','js/core/game.js?build=26'])assert(html.includes(marker),`cache marker missing: ${marker}`);
