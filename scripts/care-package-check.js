...
for(const marker of ['app.css?build=30','js/core/config.js?build=20','js/core/economy.js?build=1','js/core/state.js?build=16','js/systems/merchant.js?build=4','js/systems/care-package.js?build=1','js/audio.js?build=12'])if(!html.includes(marker))fail(`cache/build marker missing: ${marker}`);
