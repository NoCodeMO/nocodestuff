...
for(const marker of ['app.css?build=58','js/core/config.js?build=36','js/core/economy.js?build=2','js/core/state.js?build=24','js/systems/operations.js?build=2','js/systems/merchant.js?build=4','js/systems/care-package.js?build=2','js/audio.js?build=15'])if(!html.includes(marker))fail(`cache/build marker missing: ${marker}`);
