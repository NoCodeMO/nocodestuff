...
for(const marker of ['app.css?build=31','js/core/config.js?build=21','js/core/economy.js?build=1','js/core/state.js?build=17','js/systems/merchant.js?build=4','js/systems/care-package.js?build=1','js/audio.js?build=13'])if(!html.includes(marker))fail(`cache/build marker missing: ${marker}`);
