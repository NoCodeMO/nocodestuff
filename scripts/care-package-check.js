...
for(const marker of ['app.css?build=62','js/core/config.js?build=38','js/core/economy.js?build=3','js/core/state.js?build=28','js/systems/operations.js?build=3','js/systems/merchant.js?build=5','js/systems/care-package.js?build=3','js/audio.js?build=19'])if(!html.includes(marker))fail(`cache/build marker missing: ${marker}`);
