...
for(const marker of ['app.css?build=34','js/core/config.js?build=24','js/core/economy.js?build=2','js/core/state.js?build=21','js/systems/operations.js?build=2','js/systems/merchant.js?build=4','js/systems/care-package.js?build=2','js/audio.js?build=13'])if(!html.includes(marker))fail(`cache/build marker missing: ${marker}`);
