...
const context={window:{}};vm.runInNewContext(configSource,context);const cfg=context.window.BunkrConfig,rooms=cfg.ROOMS,milestones=cfg.ROOM_MILESTONES,economy=cfg.ROOM_ECONOMY;
...
assert(/bunkr:room-upgraded',roomMilestoneCelebrate/.test(visualSource),'Milestone celebration must reuse the room-upgraded event');
