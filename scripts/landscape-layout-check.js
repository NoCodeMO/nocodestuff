...
if(!/app\.css\?build=56/.test(html))fail('index must cache-bust the landscape stylesheet');
...
console.log('Afterlight landscape layout passed: full-width combat, vertical navigation and on-demand four-column BUNKER intelligence.');
