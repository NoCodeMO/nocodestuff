...
if(!/67%,100%\{aspect-ratio:700\/631;background-size:253\.5% auto;background-position:100% 11\.5%\}/.test(css))fail('the corpse frame must include the complete Drifter skull instead of clipping its left edge');
