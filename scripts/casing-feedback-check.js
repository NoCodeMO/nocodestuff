...
for(const marker of ['app.css?build=58&pets=1&casing=1','js/ui/visuals.js?build=29&casing=1','js/audio.js?build=16&casing=1&realcasing=1'])assert(html.includes(marker),`cache marker missing: ${marker}`);
