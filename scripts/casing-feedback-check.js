...
for(const marker of ['app.css?build=59&pets=1&casing=1','js/core/state.js?build=26&pets=1&casing=1','js/systems/command-center.js?build=9&pets=1&casing=1','js/ui/visuals.js?build=30&casing=1','js/audio.js?build=19&casing=2&realcasing=2'])assert(html.includes(marker),`cache marker missing: ${marker}`);
