...
if(!html.includes('app.css?build=54')||!html.includes('js/ui/visuals.js?build=27'))fail('world asset cache markers are stale');
...
console.log('Afterlight static world passed: pointer and combat interactions cannot move the sky, city, bunker or road; only 42s cloud drift remains.');
