...
assert(html.indexOf('js/core/economy.js?build=2')<html.indexOf('js/core/state.js?build=21'),'the safe economy module must load before save-state normalization');
