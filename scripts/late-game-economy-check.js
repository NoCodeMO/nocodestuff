...
assert(html.indexOf('js/core/economy.js?build=3')<html.indexOf('js/core/state.js?build=27'),'the safe economy module must load before save-state normalization');
