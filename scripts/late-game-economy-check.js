...
assert(html.indexOf('js/core/economy.js?build=1')<html.indexOf('js/core/state.js?build=16'),'the safe economy module must load before save-state normalization');
