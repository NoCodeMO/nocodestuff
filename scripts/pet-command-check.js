...
for(const marker of ['app.css?build=62','js/core/config.js?build=38','js/core/state.js?build=28','js/systems/expeditions.js?build=13','js/systems/command-center.js?build=9'])assert(html.includes(marker),`cache marker missing: ${marker}`);
