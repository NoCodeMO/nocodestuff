...
for(const marker of ['app.css?build=58','js/core/config.js?build=36','js/core/state.js?build=24','js/systems/expeditions.js?build=11','js/systems/command-center.js?build=7'])assert(html.includes(marker),`cache marker missing: ${marker}`);
