...
if(!/app\.css\?build=62/.test(html))fail('index must cache-bust the portrait stylesheet');
...
console.log('Bunkr portrait combat passed: fixed solo, brute, horde and corpse formations are protected by responsive geometry checks.');
