...
const EXPEDITION_COMPANIONS=[
  {id:'ash-hound',icon:'◆',name:'ASH HOUND',role:'WASTELAND COMPANION',description:'A loyal tracker recovered from the red-zone kennels.'},
  {id:'signal-crow',icon:'⌁',name:'SIGNAL CROW',role:'SCOUT COMPANION',description:'A sharp-eyed bird that follows working radio towers.'},
  {id:'rad-cat',icon:'✦',name:'RAD-CAT',role:'BUNKER COMPANION',description:'An impossible little survivor with a faint uranium glow.'}
];
const SPECIAL_ROOMS=[
...
const ENEMIES=[
  {id:'common',rarity:'COMMON',name:'THE DRIFTER',chance:55,asset:'assets/enemy-common-drifter.webp',idleAsset:'assets/enemy-common-drifter-idle.png',walkAsset:'assets/enemy-common-drifter-walk.png',hitAsset:'assets/enemy-common-drifter-hit.png',deathAsset:'assets/enemy-common-drifter-death.png',hpMultiplier:1,bountyMultiplier:1,scrapMultiplier:1,glow:'transparent',accent:'#b7b4a5'},
  ...
  {id:'brute',rarity:'BRUTE',name:'THE BREAKER',chance:1,asset:'assets/enemy-brute-breaker.webp',deathAsset:'assets/enemy-brute-breaker-death.png',hpMultiplier:9,bountyMultiplier:16,scrapMultiplier:10,glow:'transparent',accent:'#d76a50',brute:true}
];
...
window.AfterlightConfig=Object.freeze({ROOMS,ROOM_ECONOMY,ROOM_MILESTONES,RESEARCH,EXPEDITIONS,SPECIALISTS,EXPEDITION_COMPANIONS,SPECIAL_ROOMS,MERCHANT_OFFERS,SURVIVOR_SKINS,PRESTIGE,SURVIVOR_DIALOGUE,COMMAND_MESSAGES,ENEMIES,COMBAT,CARE_PACKAGE,OFFLINE,OPERATIONS});
})();
