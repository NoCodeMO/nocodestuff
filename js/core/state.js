...
const defaults=()=>({
  schema:5,coins:0,total:0,food:0,water:0,power:0,scrap:0,science:0,kills:0,level:1,bunker:1,
...
function normalize(){
  ...
  state.specialRooms=state.specialRooms||{};state.settings={...base.settings,...(state.settings||{})};
