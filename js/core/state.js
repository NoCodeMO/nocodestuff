...
const defaults=()=>({
  schema:8,coins:0,total:0,food:0,water:0,power:0,scrap:0,science:0,uranium:0,kills:0,level:1,bunker:1,
...
const state={...base,...old,rooms:{...base.rooms,...(old.rooms||{})},research:{...base.research,...(old.research||{})},stats:{...base.stats,...(old.stats||{}),rarityKills:{...base.stats.rarityKills,...(old.stats?.rarityKills||{})}},merchant:{...base.merchant,...(old.merchant||{}),active:{...base.merchant.active,...(old.merchant?.active||{})},purchases:{...base.merchant.purchases,...(old.merchant?.purchases||{})}},settings:{...base.settings,...(old.settings||{})}};
...
function normalize(){
  ...
  state.specialRooms=state.specialRooms||{};state.researchRuntime=state.researchRuntime||{active:null,ready:null};state.merchant={...base.merchant,...(state.merchant||{}),active:{...base.merchant.active,...(state.merchant?.active||{})},purchases:{...base.merchant.purchases,...(state.merchant?.purchases||{})}};state.settings={...base.settings,...(state.settings||{})};
