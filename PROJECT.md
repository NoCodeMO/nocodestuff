...
- `scripts/research-network-check.js` and `scripts/research-network-probe.html` - all four branches, 17 project IDs, 97 levels, prerequisites, Prestige gates, save migration, timer/claim lifecycle, gameplay effects, plus real 390×844 portrait and 844×390 landscape geometry/lifecycle browser probes.
