...
- Every successful shot now emits a capped, true DOM pixel-blood burst through the existing `afterlight:shot` event. Each infected type has its own blood/accent palette, particle weight and recoil animation; Blue Shield and the Gilded Warden mix restrained armor sparks into their blood. The renderer hard-caps live particles at 48 and disables them for reduced-motion/reduced-effects players.
